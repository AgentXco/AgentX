...
class RaydiumManager:
    ...
    @staticmethod
    def buy_with_raydium(agent: BaseSolanaClient, pair_address: str, sol_in: float = 0.01, slippage: int = 5) -> bool:
        """
        Executes a buy operation on the specified Raydium pair.

        Args:
            agent (BaseSolanaClient): The client containing wallet and RPC connection details.
    ...
    @staticmethod
    def sell_with_raydium(agent: BaseSolanaClient, pair_address: str, percentage: int = 100, slippage: int = 5) -> bool:
        """
