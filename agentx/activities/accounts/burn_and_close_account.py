...
from agentify.foundation import BaseSolanaClient


class BurnManager:
    @staticmethod
    def burn_and_close_account(agent:BaseSolanaClient, token_account: str):
        """
        Burns tokens and closes the given token account.

        Parameters:
        agent (BaseSolanaClient): The client instance containing wallet and RPC configuration.
