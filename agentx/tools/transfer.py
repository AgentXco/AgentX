...
from agentx.agent import SolanaOpsKit
...
class SolanaTransferHelper:
    ...
    @staticmethod
    async def transfer_native_sol(agent: SolanaOpsKit, to: Pubkey, amount: float) -> str:
        """
        Transfer native SOL.

        Args:
            agent: SolanaOpsKit instance
    ...
    @staticmethod
    async def confirm_transaction(agent: SolanaOpsKit, signature: str) -> None:
...
class TokenTransferManager:
    ...
    def __init__(self, agent: SolanaOpsKit):
        self.agent = agent
