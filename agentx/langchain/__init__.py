...
from agentx.tools import create_image, fetch_price
from agentx.utils import toJSON
...
class SolanaBalanceTool(BaseTool):
    ...
    def __init__(self, solana_kit: BaseSolanaClient):
...
class SolanaGetWalletAddressTool(BaseTool):
    ...
    description:str = "Get the wallet address of the client"
...
def create_solana_tools(solana_kit: BaseSolanaClient):
    return [
